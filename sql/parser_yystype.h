...
enum PT_joined_table_type {
  ...
  JTT_STRAIGHT_INNER = JTT_STRAIGHT | JTT_INNER,  // 为 0x03
  JTT_NATURAL_INNER = JTT_NATURAL | JTT_INNER,  //  为 0x05
  JTT_NATURAL_LEFT = JTT_NATURAL | JTT_LEFT,  //  为 0x0C
  JTT_NATURAL_RIGHT = JTT_NATURAL | JTT_RIGHT,  //  为 0x14
  JTT_NATURAL_FULL = JTT_NATURAL | JTT_FULL  //  为 0x24
};
